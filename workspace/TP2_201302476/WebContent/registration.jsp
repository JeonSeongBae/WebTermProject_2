		...
		<tfoot>
			<tr>
				...
				<td><input type="button" value="제출하기" onclick="checkSubmit()"
					required></td>
									<td><input type="button" value="돌아가기" onclick="location.href='http://localhost:8080/TP2_201302476/login.jsp'"
					required></td>
			</tr>
		</tfoot>
	</table>
...
<script type="text/javascript">
	...
	function send_email() {
		location.href = "http://localhost:8080/TP2_201302476/email.jsp?ID="+document.getElementById("ID").value + "&Email=" + document.getElementById("Email").value;
	}
